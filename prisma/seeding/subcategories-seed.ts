    ...
    const subcategoriesByCategory: Record<string, { name: string; description: string }[]> = {
        Electrónica: [
            ...
            { name: "Laptops y computadoras", description: "Equipos informáticos y accesorios" },
            {
                ...
                description: "Complementos para dispositivos electrónicos",
            },
        ...
        "Hogar y muebles": [
            ...
            { name: "Iluminación", description: "Lámparas y sistemas de iluminación" },
            {
                ...
                description: "Equipos para reparaciones y proyectos DIY",
            },
        ],
        "Deportes y fitness": [
            {
                name: "Equipos deportivos",
                description: "Material para diferentes disciplinas deportivas",
            },
            {
                name: "Ropa deportiva",
                description: "Indumentaria especializada para actividades físicas",
            },
            {
                name: "Accesorios de fitness",
                description: "Complementos para entrenamiento y ejercicio",
            },
        ...
        "Juguetes y juegos": [
            {
                ...
                description: "Juguetes para el aprendizaje y desarrollo",
            },
            {
                name: "Juguetes de acción y figuras",
                description: "Muñecos y figuras coleccionables",
            },
        ...
        "Salud y belleza": [
            ...
            { name: "Perfumes", description: "Fragancias y aromas personales" },
            {
                ...
                description: "Complementos para la salud y bienestar",
            },
        ...
        "Alimentos y bebidas": [
            ...
            { name: "Snacks y golosinas", description: "Aperitivos y dulces" },
            {
                ...
                description: "Alimentos de alta calidad y especialidades",
            },
            {
                name: "Suplementos dietéticos",
                description: "Complementos alimenticios especializados",
            },
        ],
        "Libros, música y películas": [
            ...
            { name: "Música", description: "Álbumes y composiciones musicales" },
            {
                ...
                description: "Herramientas para la creación musical",
            },
        ...
        "Tecnología para el hogar inteligente": [
            ...
            {
                name: "Automación del hogar",
                description: "Sistemas para automatizar procesos domésticos",
            },
            {
                name: "Gadgets tecnológicos",
                description: "Dispositivos innovadores y accesorios tech",
            },
        ],
        Servicios: [
            { name: "Servicios de envío", description: "Transporte y entrega de mercancías" },
            {
                ...
                description: "Servicios de arreglo y conservación",
            },
            ...
            {
                name: "Servicios de belleza y salud",
                description: "Tratamientos de bienestar y estética",
            },
        ],
        "Automóviles y vehículos": [
            ...
            {
                name: "Herramientas y equipos para vehículos",
                description: "Instrumentos para mantenimiento vehicular",
            },
        ],
        "Arte y coleccionables": [
            ...
            {
                name: "Coleccionables y ediciones limitadas",
                description: "Artículos de valor para coleccionistas",
            },
            {
                name: "Materiales para artistas",
                description: "Suministros para creación artística",
            },
        ],
        "Viajes y turismo": [
            ...
            { name: "Alojamientos y hospedaje", description: "Estancias y hospedajes temporales" },
            {
                ...
                description: "Artículos para facilitar los desplazamientos",
            },
        ],
        "Tecnología y software": [
            ...
            { name: "Licencias de software", description: "Permisos de uso para programas" },
            {
                ...
                description: "Aplicaciones para mejorar eficiencia",
            },
    ...
    for (const category of categories) {
        ...
        if (subcategories) {
            ...
            if (subcategoriesToCreate.length > 0) {
                ...
                console.log(
                    `Se crearon ${subcategoriesToCreate.length} subcategorías para ${category.name}`,
                );
            }
        }
    }
