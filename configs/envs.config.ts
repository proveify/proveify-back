...
export const APP_ENV = (process.env.APP_ENV ?? "development") as string;
export const CORS_URL_LIST = (process.env.CORS_ULRS?.split(",") ?? []) as string[];
export const BUCKET = (process.env.BUCKET ?? "proveify-bucket") as string;
